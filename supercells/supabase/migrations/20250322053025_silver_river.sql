/*
  ...
  1. Changes
    - Add lead_score column to store AI-generated score (0-100)
    - Add ai_interest_level to store AI interest analysis (0-100)
...
ADD COLUMN IF NOT EXISTS ai_interest_level integer CHECK (ai_interest_level >= 0 AND ai_interest_level <= 100),
