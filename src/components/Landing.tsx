        ...
        <div className="mx-auto max-w-4xl py-24 sm:py-32">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg leading-8 text-zinc-400">
              Transform your lead generation and management with our AI-powered platform. 
              Capture, nurture, and convert leads with intelligent insights and automated workflows.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-zinc-400">
              Our comprehensive suite of tools helps you streamline your lead management process from start to finish.
            </p>
          </div>
          ...
          <div className="mx-auto mt-16 max-w-5xl">
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <div className="relative flex flex-col gap-6 sm:flex-row lg:flex-col h-full">
                ...
                <div className="sm:min-w-0 sm:flex-1">
                  ...
                  <p className="mt-2 text-base leading-7 text-zinc-400">
                    Get intelligent recommendations and insights to optimize your lead conversion strategy.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex flex-col gap-6 sm:flex-row lg:flex-col h-full">
                ...
                <div className="sm:min-w-0 sm:flex-1">
                  <p className="text-lg font-semibold leading-8 text-zinc-200">Team Collaboration</p>
                  <p className="mt-2 text-base leading-7 text-zinc-400">
